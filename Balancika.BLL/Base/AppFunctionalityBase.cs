...
namespace Balancika.BLL.Base
{
	...
	{
		protected static Balancika.DAL.AppFunctionalityDAL dal = new Balancika.DAL.AppFunctionalityDAL();
		...
		protected  AppFunctionality GetObject(DataRow dr)
		{
			...
			objAppFunctionality.LastUpdated = (dr["LastUpdated"] == DBNull.Value) ? DateTime.MinValue : (DateTime)dr["LastUpdated"];
			objAppFunctionality.Icon = (dr["Icon"] == DBNull.Value) ? "" : (String)dr["Icon"];
