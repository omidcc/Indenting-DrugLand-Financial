<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ListTableLists.aspx.cs" Inherits="Balancika.ListTableLists" %>
        ...
        <section class="form-horizontal">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">ListTable List</h3>
                ...
                <div class="box-body">
                    <div id="divCompanyTable" class="dataTables_wrapper form-inline dt-bootstrap">
                        <div class="row">
                            <div class="col-sm-6">
                                <asp:Button class="btn" ID="btnAddNew" runat="server" ClientIDMode="Static" CssClass="btn btn-success" Text="Add New List" OnClick="btnAddNew_OnClick" />        
                            </div>
                                ...
                                <telerik:RadGrid ID="RadGrid1" runat="server" AllowFilteringByColumn="False" 
                                    ...
                                    <mastertableview>
                                        <Columns>
                                            ...
                                            <telerik:GridBoundColumn  DataField="ListType" HeaderText="List Type" UniqueName="colName">
                                            </telerik:GridBoundColumn>
                                           
                                             <telerik:GridBoundColumn  DataField="ListValue" HeaderText="List Value" UniqueName="colName">
                                            </telerik:GridBoundColumn>
