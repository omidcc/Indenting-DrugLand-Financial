...
namespace Balancika.BLL.Base
{
	...
	{
		protected static Balancika.DAL.UserLoginLogDAL dal = new Balancika.DAL.UserLoginLogDAL();
		...
		public  Int32 InsertUserLoginLog()
		{
			...
			lstItems.Add("@LogOutTime", LogOutTime.ToString(CultureInfo.InvariantCulture));
