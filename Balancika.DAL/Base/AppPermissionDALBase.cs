...
namespace Balancika.DAL.Base
{
	public class AppPermissionDALBase : SqlServerConnection
	{
		...
		{
			string sqlQuery ="Insert into AppPermission (Id, RoleId, UserId, CompanyId, FunctionalityId, IsView, IsInsert, IsUpdate, IsDelete, IsApprove) values(@Id, @RoleId, @UserId, @CompanyId, @FunctionalityId, @IsView, @IsInsert, @IsUpdate, @IsDelete, @IsApprove);";
			try
			{
