...
namespace Balancika.DAL.Base
{
	public class UserLoginLogDALBase : SqlServerConnection
	{
		...
		{
			string sqlQuery ="Insert into UserLoginLog (Id, UserId, Status, SessionId, LoginTime, LoginPCName, IpAddress, LogOutTime) values(@Id, @UserId, @Status, @SessionId, @LoginTime, @LoginPCName, @IpAddress, @LogOutTime);";
			try
			{
